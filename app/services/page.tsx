                ...
                <div className="max-w-sm mx-auto px-4 py-6">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-center">
                            <h1 className="text-lg font-bold">{getCategoryName()}</h1>
                            {getSubCategoryName() && (
                                <p className="text-sm text-white/90">{getSubCategoryName()}</p>
                            )}
                        </div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <div className="text-center mb-6">
                                <div className="text-4xl mb-3">{selectedProvider.avatar}</div>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
                <div className="max-w-sm mx-auto px-4 py-3">
                    <div className="flex justify-around">
                        ...
                        >
                            <span className="text-xl">📂</span>
                            <span className="text-xs font-semibold">التصنيفات</span>
                        </Link>
                        <Link
                            href="/orders"
                            className="flex flex-col items-center space-y-1 text-gray-400"
